...
class Empresa{
	...
	public function creare($nit, $nombre, $direccion, $telefono1, $telefono2, $telefono3, $logo, $estado, $logotemp){
		...
		$sql="INSERT INTO empresa (nit, nombre, direccion, telefono1, telefono2, telefono3, logo, estado) 
        VALUES ('$nit', '$nombre', '$direccion', '$telefono1', '$telefono2', '$telefono3', '$logo', '$estado')";

		if ($cn->query($sql)) {
			move_uploaded_file($logotemp, $logo);
            echo 'Empresa creada correctamente.';
		}else{
            echo 'Error, no se creo la empresa.';
